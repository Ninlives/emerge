 ...
 *
 * Disassembly of dsdt.dat, Fri Nov 18 01:48:16 2022
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000103C7 (66503)
 *     Revision         0x02
 *     Checksum         0x66
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x0107200A)
{
    ...
    External (_SB_.NPCF.UOCT, UnknownObj)
    ...
    External (_SB_.PCI0.SBRG.EC0_.WATM, IntObj)
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xB2E20000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xB2E24000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xB81A9F98)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xB81ACD18, 0x0D)
    ...
    Scope (_SB)
    {
        OperationRegion (RAMW, SystemMemory, 0xB81AD000, 0x0100)
                    ...
                    If ((IIA0 == 0x00090019))
                    {
                        ...
                        ElseIf ((IIA1 != Zero))
                        {
                            ...
                            If ((GPUV == 0x02))
                            {
                                ...
                                ElseIf (((ACPT & 0x02) == 0x02))
                                {
                                    Local5 = 0xA5
                                }
                                ElseIf (((ACPT & 0x03) == 0x03))
                                {
                                    Local5 = 0x50
                                }
                                Else
            ...
            Device (PRT1)
            {
                ...
                Device (DCAM)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        Return (XPLD) /* \_SB_.PCI0.GP19.XHC2.RHUB.PRT1.DCAM._PLD.XPLD */
                    }
                }
            }
        }
