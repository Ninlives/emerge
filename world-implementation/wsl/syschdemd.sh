...
exportCmd="export __WSL_INSIDE_NIXOS=1; export WSLENV=\"$WSLENV\"; export WT_SESSION=\"$WT_SESSION\"; export WT_PROFILE_ID=\"$WT_PROFILE_ID\"; export WSL_INTEROP=\"$WSL_INTEROP\"; export VSCODE_WSL_EXT_LOCATION=\"$VSCODE_WSL_EXT_LOCATION\""
